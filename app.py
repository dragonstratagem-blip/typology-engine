...
def apply_styles(letter, mag_pol, mag_val, spol, smag, dof_val):
...
if c2.button("Generate"):
    ...
    for i in range(4):
        ...
        html_out += apply_styles(letter, inputs["mp" + str(i)], inputs["mm" + str(i)], inputs["sp" + str(i)], inputs["sm" + str(i)], dof_val)
